...
const i18n = {
  en: {
    ...
    providerLimitFallback: "Trusted AI detector providers are currently rate-limited or out of quota. The built-in local result is less accurate. Please contact the admin at viva.sw.1911@gmail.com or Telegram @movewannamove to report the issue and get support.",
    provider: "Provider",
  ...
  vi: {
    ...
    providerLimitFallback: "Các AI detector provider uy tín hiện đang bị rate limit hoặc hết quota. Kết quả built-in local sẽ kém chính xác hơn. Vui lòng liên hệ admin qua email viva.sw.1911@gmail.com hoặc Telegram @movewannamove để báo lỗi và được hỗ trợ.",
