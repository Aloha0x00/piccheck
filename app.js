...
const i18n = {
  en: {
    ...
    memberBenefitEvidenceLink: "Share evidence links with anyone",
    ...
    memberLimit: "Member benefits: scan 3 images at once, continue after the 5-image guest limit, and share evidence links.",
  ...
  vi: {
    ...
    memberBenefitEvidenceLink: "Gửi link evidence cho bất cứ ai",
    ...
    memberLimit: "Lợi ích member: scan 3 ảnh cùng lúc, scan vượt giới hạn 5 ảnh của guest và gửi link evidence.",
...
Object.assign(i18n.zh, {
  ...
  signOutConfirmBody: "确定要退出这个账户吗？",
  ok: "确定",
  cancel: "取消",
  memberBenefitsTitle: "会员权益",
  memberFreeBadge: "推广期免费",
  memberBenefitUnlimited: "超过访客限制后继续扫描",
  memberBenefitBatch: "一次扫描 3 张图片",
  memberBenefitHistory: "在个人资料中保存扫描历史",
  memberBenefitEvidenceLink: "向任何人分享证据链接",
  iconCredit: "图标风格参考：Iconfinder 上 Eucalyp Studio 的免费 AI 图标包。",
  workflowEyebrow: "如何使用 PIC Check",
  workflowTitle: "用 3 个简单步骤扫描图片",
  workflowBody: "按此流程选择图片、运行分析，并通过视觉结果和详细原因查看结论。",
  workflowStepOneTitle: "选择图片",
  workflowStepOneBody: "从设备上传，或把图片拖入高亮区域。会员最多可选择 3 张图片。",
  workflowStepTwoTitle: "点击扫描",
  workflowStepTwoBody: "预览出现后，点击所选图片上或工具栏中的扫描按钮开始分析。",
  workflowStepThreeTitle: "查看结果",
  workflowStepThreeBody: "查看标记、分数和检测信号，理解图片为何是真实、可疑或 AI 生成。",
  imageUrlPlaceholder: "粘贴公开图片 URL，然后按 Enter 或离开输入框",
  loadUrlImage: "加载 URL",
  urlLoading: "正在加载图片...",
  urlFetchProgress: "正在获取图片",
  urlInvalid: "请输入有效的公开 http(s) 图片 URL。",
  urlScanServerRequired: "URL 扫描需要本地开发服务器或 Vercel 部署。请运行 npm run dev 并打开 localhost URL。",
  urlFetchFailed: "无法加载该图片 URL。链接必须是公开的、直接指向图片且小于 12MB。",
  urlNotImage: "该 URL 不指向受支持的图片文件。请粘贴直接的 JPG、PNG、WEBP 或 GIF 图片链接。",
  urlUnsupportedFormat: "该图片 URL 使用不支持的格式。请使用 JPG、PNG、WEBP 或 GIF。",
  duplicateImageSkipped: "这张图片已被选择，因此不会重复添加。",
  heicUnsupported: "暂不支持 HEIC/HEIF，因为浏览器画布分析和检测提供商可能无法稳定解码。请先转换为 JPG 或 PNG。",
  unsupportedImageFormat: "不支持的图片格式。请使用 JPG、PNG、WEBP 或 GIF。",
  shareLinkReady: "图片链接已生成",
  copyAgain: "再次复制",
  manualCopyHint: "链接已生成。请从下方输入框复制。",
  signInToCopyLink: "登录会员后可复制图片链接。",
  sharePermissionDenied: "Firestore 权限被拒绝。请允许已登录会员创建共享图片链接。",
  shareImageTooLarge: "带标记图片过大，无法创建分享链接。",
  shareFirebaseUnavailable: "Firebase 尚未准备好。",
  noteBody: "本工具基于视觉信号和提供商信号估算 AI 生成风险。结果是概率性的，可能出错，不应作为法律、财务、就业、学术或其他高影响决策的唯一依据。",
  supportTitle: "需要帮助？",
  supportBadge: "人工支持",
  supportBody: "如果需要关于扫描结果、账户访问或配额警告的帮助，请联系 PIC Check 支持。",
  supportEmail: "邮件支持",
  supportTelegram: "Telegram 聊天",
  supportBotTitle: "PIC Check 支持",
  supportBotStatus: "通常回复很快",
  supportBotBody: "需要扫描结果或 API 配额警告方面的帮助？请直接联系我们。",
  supportBotOpen: "打开支持",
  supportBotHide: "隐藏支持",
  firebaseMissing: "尚未配置 Firebase。请添加 Firebase 配置以启用登录。",
  firebaseReady: "Firebase 已准备好。使用 Google 继续以启用会员功能。",
  authFailed: "登录失败。请检查提供商设置和凭据。",
  authUnauthorizedDomain: "此域名被 Google 登录阻止。请使用 http://localhost:3000 打开应用，或在 Firebase Authentication > Settings > Authorized domains 中添加此域名。",
  authPopupBlocked: "Google 登录弹窗被阻止。请允许弹窗后重试。",
  authOperationNotAllowed: "此 Firebase 项目未启用 Google 提供商。",
  authRedirecting: "正在打开 Google 登录...",
  localFallback: "API 不可用。已使用本地启发式备用检测。",
  providerLimitFallback: "可信 AI 检测提供商当前被限流或配额用尽。本地内置结果准确性较低。请通过 johnlahboo@gmail.com 或 Telegram @movewannamove 联系支持以报告问题并获取帮助。",
  provider: "提供商",
  providerScore: "{provider} 返回 AI 分数 {score}%。",
  cacheSource: "结果来自 {layer} 缓存。",
  fallbackChain: "提供商备用链：{chain}。",
  screenshotNote: "该图片看起来像截图或 UI 图形，因此应谨慎解读置信度。",
  aiMarker: "AI 生成 {score}%",
  aiEditedMarker: "AI 编辑警告 {score}%",
  viewingResult: "正在查看结果",
  selectedForScan: "已选择扫描",
  authNeeded: "请登录以一次扫描 3 张图片或在 5 次访客扫描后继续。",
  firebaseNotReady: "Firebase 尚未配置。",
  fileModeWarning: "应用以本地文件方式打开，因此 API 不可用。请运行 npm run dev 并打开 http://127.0.0.1:3000。",
  unableAnalyze: "无法分析这张图片。",
  browserReadError: "浏览器无法读取这张图片。",
  smoothSynthetic: "平滑的颜色过渡可能类似合成纹理。",
  naturalVariation: "自然变化会降低 AI 风险分数。",
  lowEdges: "低锐边密度表示图片较柔和或被平滑处理。",
  clearEdges: "清晰的边缘细节会降低 AI 风险分数。",
  limitedBrightness: "亮度多样性有限可能表示渲染或重度处理。",
  diverseBrightness: "多样的亮度分布会降低风险分数。",
  highSaturation: "高色彩饱和度可能出现在生成图片中。",
  squareFormat: "高分辨率方形格式常见于图片生成工具。",
  pngWebp: "PNG/WEBP 通常比 JPEG 照片缺少相机痕迹。",
  scoreRule: "决策规则：高于 {threshold}% 标记为 AI 生成，{realThreshold}% 到 {threshold}% 标记为可能 AI 辅助编辑，低于 {realThreshold}% 标记为真实；本图得分 {score}%。",
  smoothnessMetric: "平滑度：{value}% 的采样过渡非常柔和。较高值可能表示生成或重度处理纹理。",
  edgeMetric: "边缘密度：{value}% 的采样区域有明显对比。真实照片通常保留更多不规则边缘和微细节。",
  entropyMetric: "亮度多样性：{value}%。较低值可能来自 UI 截图、插画、渲染或压缩/生成图片。",
  saturationMetric: "平均色彩饱和度：{value}%。过于均匀或优化的颜色可能增加怀疑，但这只是弱信号。",
  dimensionMetric: "图片尺寸：{width} × {height}。方形高分辨率文件常见于生成工具；截图需要降低置信解读。",
  screenshotMetric: "截图检查：{result}。类似截图的图片可能过于平滑，因此该信号可避免过度断定 AI。",
  screenshotYes: "类似截图",
  screenshotNo: "不明显类似截图",
  formatMetric: "格式检查：{format}。PNG/WEBP 通常缺少相机 metadata，但单独格式并不是证明。"
});

Object.assign(i18n.hi, {
  signOut: "साइन आउट",
  signOutConfirmTitle: "साइन आउट करें?",
  signOutConfirmBody: "क्या आप वाकई इस account से sign out करना चाहते हैं?",
  ok: "OK",
  cancel: "Cancel",
  memberBenefitsTitle: "Member benefits",
  memberFreeBadge: "Promo में FREE",
  memberBenefitUnlimited: "Guest limit के बाद unlimited scans",
  memberBenefitBatch: "एक साथ 3 images scan करें",
  memberBenefitHistory: "Profile में scan history save करें",
  memberBenefitEvidenceLink: "किसी को भी evidence links share करें",
  title: "PIC Check images real हैं या AI-generated, यह check करता है",
  eyebrow: "PIC Check image authenticity platform",
  featureOneTitle: "Modern ML analysis",
  workflowEyebrow: "PIC Check कैसे use करें",
  workflowTitle: "3 आसान steps में images scan करें",
  workflowBody: "Images चुनें, analysis run करें और detailed reasons के साथ visual result पढ़ें।",
  workflowStepOneTitle: "Images चुनें",
  workflowStepOneBody: "Device से upload करें या highlighted drop area में images drag करें। Members 3 images तक चुन सकते हैं।",
  workflowStepTwoTitle: "Click to Scan",
  workflowStepTwoBody: "Preview दिखने के बाद selected image या toolbar पर scan button दबाकर analysis शुरू करें।",
  workflowStepThreeTitle: "Result check करें",
  workflowStepThreeBody: "Stamp, score और detection signals देखें ताकि समझ सकें image real, suspicious या AI-generated क्यों है।",
  imageUrlPlaceholder: "Public image URL paste करें, फिर Enter दबाएं या field छोड़ दें",
  loadUrlImage: "URL load करें",
  urlLoading: "Image load हो रही है...",
  urlFetchProgress: "Image fetch हो रही है",
  urlInvalid: "Valid public http(s) image URL enter करें।",
  urlScanServerRequired: "URL scan के लिए local dev server या Vercel deployment चाहिए। npm run dev चलाएं और localhost URL खोलें।",
  urlFetchFailed: "यह image URL load नहीं हुआ। Link public, direct image और 12MB से कम होना चाहिए।",
  urlNotImage: "यह URL supported image file पर point नहीं करता। Direct JPG, PNG, WEBP या GIF image link paste करें।",
  urlUnsupportedFormat: "इस image URL का format unsupported है। JPG, PNG, WEBP या GIF use करें।",
  duplicateImageSkipped: "यह image पहले से selected है, इसलिए फिर से add नहीं हुई।",
  heicUnsupported: "HEIC/HEIF अभी supported नहीं है क्योंकि browser canvas analysis और detector providers इसे reliably decode नहीं कर सकते। Scan से पहले JPG या PNG में convert करें।",
  unsupportedImageFormat: "Unsupported image format. JPG, PNG, WEBP या GIF use करें।",
  shareLinkReady: "Image link ready",
  copyAgain: "फिर copy करें",
  manualCopyHint: "Link ready है। नीचे field से copy करें।",
  signInToCopyLink: "Image links copy करने के लिए member sign in करें।",
  sharePermissionDenied: "Firestore permission denied. Signed-in members को shared image links create करने दें।",
  shareImageTooLarge: "Marked image बहुत बड़ी है, share link नहीं बन सकता।",
  shareFirebaseUnavailable: "Firebase अभी ready नहीं है।",
  noteBody: "यह tool visual और provider signals से AI-generation risk estimate करता है। Results probabilistic हैं, गलत हो सकते हैं, और legal, financial, employment, academic या other high-impact decisions के sole basis के रूप में use नहीं होने चाहिए।",
  supportTitle: "Help चाहिए?",
  supportBadge: "Human support",
  supportBody: "Scan results, account access या quota warnings में help चाहिए तो PIC Check support से contact करें।",
  supportEmail: "Email support",
  supportTelegram: "Telegram पर chat करें",
  supportBotTitle: "PIC Check support",
  supportBotStatus: "Usually fast replies",
  supportBotBody: "Scan result या API quota warning में help चाहिए? हमसे direct contact करें।",
  supportBotOpen: "Support खोलें",
  supportBotHide: "Support छिपाएं",
  firebaseMissing: "Firebase अभी configured नहीं है। Sign-in enable करने के लिए Firebase config add करें।",
  firebaseReady: "Firebase ready है। Member features use करने के लिए Google से continue करें।",
  authFailed: "Sign-in failed. Provider setup और credentials check करें।",
  authUnauthorizedDomain: "Google sign-in इस domain पर blocked है। App को http://localhost:3000 से खोलें या Firebase Authentication > Settings > Authorized domains में domain add करें।",
  authPopupBlocked: "Google sign-in popup blocked था। Popups allow करके फिर try करें।",
  authOperationNotAllowed: "इस Firebase project में Google provider enabled नहीं है।",
  authRedirecting: "Google sign-in open हो रहा है...",
  memberLimit: "Member benefits: 3 images एक साथ scan करें, 5-image guest limit के बाद continue करें और evidence links share करें।",
  localFallback: "API unavailable. Local heuristic fallback use हुआ।",
  providerLimitFallback: "Trusted AI detector providers अभी rate-limited या quota से बाहर हैं। Built-in local result कम accurate है। Issue report और help के लिए johnlahboo@gmail.com या Telegram @movewannamove पर contact करें।",
  provider: "Provider",
  providerScore: "{provider} ने AI score {score}% return किया।",
  cacheSource: "Result {layer} cache से loaded है।",
  fallbackChain: "Provider fallback chain: {chain}.",
  screenshotNote: "यह image screenshot/UI graphic जैसी लगती है, इसलिए confidence सावधानी से interpret करें।",
  aiMarker: "AI Generated {score}%",
  aiEditedMarker: "AI Edit Warning {score}%",
  viewingResult: "Result देखा जा रहा है",
  selectedForScan: "Scan के लिए selected",
  authNeeded: "3 images एक साथ scan करने या 5 guest scans के बाद continue करने के लिए sign in करें।",
  firebaseNotReady: "Firebase configured नहीं है।",
  fileModeWarning: "App local file के रूप में open है, इसलिए API unavailable है। npm run dev चलाएं और http://127.0.0.1:3000 खोलें।",
  unableAnalyze: "इस image को analyze नहीं किया जा सकता।",
  browserReadError: "Browser इस image को read नहीं कर सका।",
  smoothSynthetic: "Smooth color transitions synthetic texture जैसे लग सकते हैं।",
  naturalVariation: "Natural variation AI risk score कम करता है।",
  lowEdges: "Low sharp-edge density soft या smoothed image suggest करती है।",
  clearEdges: "Clear edge detail AI risk score कम करता है।",
  limitedBrightness: "Limited brightness diversity rendering या heavy processing indicate कर सकती है।",
  diverseBrightness: "Diverse brightness distribution risk score कम करता है।",
  highSaturation: "High color saturation generated images में दिख सकता है।",
  squareFormat: "High-resolution square format image generators में common है।",
  pngWebp: "PNG/WEBP में JPEG photos की तुलना में camera traces कम होते हैं।",
  scoreRule: "Decision rule: {threshold}% से ऊपर AI-generated, {realThreshold}% से {threshold}% तक possible AI-assisted edit, और {realThreshold}% से नीचे real; इस image का score {score}% है।",
  smoothnessMetric: "Smoothness: sampled transitions के {value}% बहुत soft थे। Higher values generated या heavily processed textures indicate कर सकते हैं।",
  edgeMetric: "Edge density: sampled areas के {value}% में sharp contrast था। Real photos ज्यादा irregular edges और micro-detail retain करते हैं।",
  entropyMetric: "Brightness diversity: {value}%. Low diversity flat UI screenshots, illustrations, renderings या compressed/generated images से आ सकती है।",
  saturationMetric: "Average color saturation: {value}%. बहुत even या optimized color suspicion बढ़ा सकता है, लेकिन यह weak signal है।",
  dimensionMetric: "Image size: {width} × {height}. Square high-resolution files generation tools में common हैं; screenshots को lower confidence से interpret करें।",
  screenshotMetric: "Screenshot check: {result}. Screenshot-like images artificially smooth लग सकती हैं, इसलिए यह signal over-confident AI claims कम करता है।",
  screenshotYes: "screenshot-like",
  screenshotNo: "strongly screenshot-like नहीं",
  formatMetric: "Format check: {format}. PNG/WEBP में अक्सर camera metadata नहीं होता, इसलिए format alone proof नहीं है।"
});

Object.assign(i18n.es, {
  signOut: "Cerrar sesión",
  signOutConfirmTitle: "¿Cerrar sesión?",
  signOutConfirmBody: "¿Seguro que quieres cerrar sesión en esta cuenta?",
  ok: "OK",
  cancel: "Cancelar",
  memberBenefitsTitle: "Beneficios de miembro",
  memberFreeBadge: "GRATIS durante la promoción",
  memberBenefitUnlimited: "Escaneos ilimitados tras el límite de invitado",
  memberBenefitBatch: "Escanea 3 imágenes a la vez",
  memberBenefitHistory: "Historial guardado en tu perfil",
  memberBenefitEvidenceLink: "Comparte enlaces de evidencia con cualquiera",
  workflowEyebrow: "Cómo usar PIC Check",
  workflowTitle: "Escanea imágenes en 3 pasos simples",
  workflowBody: "Sigue este flujo para elegir imágenes, ejecutar el análisis y leer el resultado visual con razones detalladas.",
  workflowStepOneTitle: "Elige imágenes",
  workflowStepOneBody: "Sube desde tu dispositivo o arrastra imágenes al área destacada. Los miembros pueden elegir hasta 3 imágenes.",
  workflowStepTwoTitle: "Click to Scan",
  workflowStepTwoBody: "Cuando aparezca la vista previa, pulsa el botón de escaneo en la imagen seleccionada o en la barra.",
  workflowStepThreeTitle: "Revisa el resultado",
  workflowStepThreeBody: "Revisa el sello, la puntuación y las señales para entender por qué la imagen es real, sospechosa o AI-generated.",
  imageUrlPlaceholder: "Pega una URL pública de imagen y presiona Enter o sal del campo",
  loadUrlImage: "Cargar URL",
  urlLoading: "Cargando imagen...",
  urlFetchProgress: "Obteniendo imagen",
  urlInvalid: "Introduce una URL pública http(s) válida de imagen.",
  urlScanServerRequired: "El escaneo por URL requiere servidor local o despliegue Vercel. Ejecuta npm run dev y abre localhost.",
  urlFetchFailed: "No se pudo cargar esa URL. Debe ser pública, directa a una imagen y menor de 12MB.",
  urlNotImage: "Esta URL no apunta a un archivo de imagen soportado. Pega un enlace directo JPG, PNG, WEBP o GIF.",
  urlUnsupportedFormat: "La imagen usa un formato no soportado. Usa JPG, PNG, WEBP o GIF.",
  duplicateImageSkipped: "Esta imagen ya está seleccionada, por eso no se añadió otra vez.",
  heicUnsupported: "HEIC/HEIF aún no está soportado porque canvas del navegador y proveedores pueden no decodificarlo de forma fiable. Convierte a JPG o PNG antes de escanear.",
  unsupportedImageFormat: "Formato no soportado. Usa JPG, PNG, WEBP o GIF.",
  shareLinkReady: "Enlace de imagen listo",
  copyAgain: "Copiar otra vez",
  manualCopyHint: "Enlace listo. Cópialo desde el campo inferior.",
  signInToCopyLink: "Inicia sesión como miembro para copiar enlaces de imagen.",
  sharePermissionDenied: "Permiso de Firestore denegado. Permite a miembros autenticados crear enlaces de imagen compartidos.",
  shareImageTooLarge: "La imagen marcada es demasiado grande para crear un enlace.",
  shareFirebaseUnavailable: "Firebase aún no está listo.",
  noteBody: "Esta herramienta estima el riesgo de generación por IA a partir de señales visuales y de proveedores. Los resultados son probabilísticos, pueden fallar y no deben usarse como única base para decisiones legales, financieras, laborales, académicas o de alto impacto.",
  supportTitle: "¿Necesitas ayuda?",
  supportBadge: "Soporte humano",
  supportBody: "Contacta a soporte de PIC Check si necesitas ayuda con resultados, acceso de cuenta o avisos de cuota.",
  supportEmail: "Soporte por email",
  supportTelegram: "Chat en Telegram",
  supportBotTitle: "Soporte PIC Check",
  supportBotStatus: "Suele responder rápido",
  supportBotBody: "¿Necesitas ayuda con un resultado o aviso de cuota API? Contáctanos directamente.",
  supportBotOpen: "Abrir soporte",
  supportBotHide: "Ocultar soporte",
  firebaseMissing: "Firebase aún no está configurado. Añade tu configuración para activar el inicio de sesión.",
  firebaseReady: "Firebase está listo. Continúa con Google para usar funciones de miembro.",
  authFailed: "Error de inicio de sesión. Revisa la configuración del proveedor y credenciales.",
  authUnauthorizedDomain: "Google sign-in está bloqueado para este dominio. Abre con http://localhost:3000 o añade el dominio en Firebase Authentication > Settings > Authorized domains.",
  authPopupBlocked: "El popup de Google fue bloqueado. Permite popups e inténtalo de nuevo.",
  authOperationNotAllowed: "El proveedor Google no está habilitado en este proyecto Firebase.",
  authRedirecting: "Abriendo Google sign-in...",
  memberLimit: "Beneficios: escanear 3 imágenes a la vez, continuar tras el límite de 5 de invitado y compartir enlaces de evidencia.",
  localFallback: "API no disponible. Se usó heurística local como respaldo.",
  providerLimitFallback: "Los proveedores fiables de detección IA están limitados o sin cuota. El resultado local es menos preciso. Contacta a johnlahboo@gmail.com o Telegram @movewannamove para reportar el problema y recibir ayuda.",
  provider: "Proveedor",
  providerScore: "{provider} devolvió una puntuación IA de {score}%.",
  cacheSource: "Resultado cargado desde caché {layer}.",
  fallbackChain: "Cadena de proveedores de respaldo: {chain}.",
  screenshotNote: "La imagen parece una captura/UI, por lo que la confianza debe interpretarse con cuidado.",
  aiMarker: "AI Generated {score}%",
  aiEditedMarker: "Advertencia edición IA {score}%",
  viewingResult: "Viendo resultado",
  selectedForScan: "Seleccionada para escaneo",
  authNeeded: "Inicia sesión para escanear 3 imágenes a la vez o continuar tras 5 escaneos de invitado.",
  firebaseNotReady: "Firebase aún no está configurado.",
  fileModeWarning: "La API no está disponible porque la app se abrió como archivo local. Ejecuta npm run dev y abre http://127.0.0.1:3000.",
  unableAnalyze: "No se pudo analizar esta imagen.",
  browserReadError: "El navegador no pudo leer esta imagen.",
  smoothSynthetic: "Transiciones de color suaves pueden parecer textura sintética.",
  naturalVariation: "La variación natural reduce la puntuación de riesgo IA.",
  lowEdges: "Baja densidad de bordes nítidos sugiere una imagen suavizada.",
  clearEdges: "Detalle de bordes claro reduce la puntuación de riesgo IA.",
  limitedBrightness: "Poca diversidad de brillo puede indicar renderizado o procesamiento fuerte.",
  diverseBrightness: "Distribución diversa de brillo reduce el riesgo.",
  highSaturation: "Alta saturación puede aparecer en imágenes generadas.",
  squareFormat: "Formato cuadrado de alta resolución es común en generadores de imagen.",
  pngWebp: "PNG/WEBP suele tener menos rastros de cámara que fotos JPEG.",
  scoreRule: "Regla: más de {threshold}% es AI-generated, de {realThreshold}% a {threshold}% es posible edición asistida por IA, y menos de {realThreshold}% es real; esta imagen obtuvo {score}%.",
  smoothnessMetric: "Suavidad: {value}% de transiciones muestreadas fueron muy suaves. Valores altos pueden indicar textura generada o muy procesada.",
  edgeMetric: "Densidad de bordes: {value}% de áreas muestreadas tuvieron contraste nítido. Fotos reales suelen conservar bordes irregulares y microdetalle.",
  entropyMetric: "Diversidad de brillo: {value}%. Valores bajos pueden venir de capturas UI, ilustraciones, renders o imágenes comprimidas/generadas.",
  saturationMetric: "Saturación media: {value}%. Color demasiado uniforme u optimizado puede aumentar sospecha, pero es una señal débil.",
  dimensionMetric: "Tamaño: {width} × {height}. Archivos cuadrados de alta resolución son comunes en herramientas generativas; las capturas requieren menor confianza.",
  screenshotMetric: "Chequeo de captura: {result}. Imágenes tipo captura pueden parecer artificialmente suaves, por eso esta señal evita afirmaciones demasiado seguras.",
  screenshotYes: "similar a captura",
  screenshotNo: "no claramente similar a captura",
  formatMetric: "Formato: {format}. PNG/WEBP suele carecer de metadata de cámara, pero el formato por sí solo no es prueba."
});

Object.assign(i18n.ar, {
  signOut: "تسجيل الخروج",
  signOutConfirmTitle: "تسجيل الخروج؟",
  signOutConfirmBody: "هل أنت متأكد أنك تريد تسجيل الخروج من هذا الحساب؟",
  ok: "موافق",
  cancel: "إلغاء",
  memberBenefitsTitle: "مزايا العضو",
  memberFreeBadge: "مجاني خلال العرض",
  memberBenefitUnlimited: "فحوصات غير محدودة بعد حد الضيف",
  memberBenefitBatch: "فحص 3 صور مرة واحدة",
  memberBenefitHistory: "حفظ سجل الفحص في ملفك",
  memberBenefitEvidenceLink: "مشاركة روابط الأدلة مع أي شخص",
  workflowEyebrow: "كيفية استخدام PIC Check",
  workflowTitle: "افحص الصور في 3 خطوات بسيطة",
  workflowBody: "اتبع هذا المسار لاختيار الصور وتشغيل التحليل وقراءة النتيجة المرئية مع الأسباب التفصيلية.",
  workflowStepOneTitle: "اختر الصور",
  workflowStepOneBody: "ارفع من جهازك أو اسحب الصور إلى المنطقة المميزة. يمكن للأعضاء اختيار حتى 3 صور.",
  workflowStepTwoTitle: "اضغط للفحص",
  workflowStepTwoBody: "بعد ظهور المعاينة، اضغط زر الفحص على الصورة المحددة أو في شريط الأدوات لبدء التحليل.",
  workflowStepThreeTitle: "راجع النتيجة",
  workflowStepThreeBody: "راجع الختم والنتيجة وإشارات الكشف لفهم لماذا الصورة حقيقية أو مشبوهة أو مولدة بالذكاء الاصطناعي.",
  imageUrlPlaceholder: "الصق رابط صورة عام ثم اضغط Enter أو اترك الحقل",
  loadUrlImage: "تحميل الرابط",
  urlLoading: "جار تحميل الصورة...",
  urlFetchProgress: "جار جلب الصورة",
  urlInvalid: "أدخل رابط صورة عام صالح http(s).",
  urlScanServerRequired: "فحص الرابط يتطلب خادم التطوير المحلي أو نشر Vercel. شغّل npm run dev وافتح localhost.",
  urlFetchFailed: "تعذر تحميل رابط الصورة. يجب أن يكون عاماً ومباشراً إلى صورة وأقل من 12MB.",
  urlNotImage: "هذا الرابط لا يشير إلى ملف صورة مدعوم. الصق رابط JPG أو PNG أو WEBP أو GIF مباشر.",
  urlUnsupportedFormat: "هذا الرابط يستخدم تنسيقاً غير مدعوم. استخدم JPG أو PNG أو WEBP أو GIF.",
  duplicateImageSkipped: "هذه الصورة محددة مسبقاً، لذلك لم تتم إضافتها مرة أخرى.",
  heicUnsupported: "HEIC/HEIF غير مدعوم حالياً لأن canvas في المتصفح ومزودي الكشف قد لا يفكونه بثبات. حوّل الصورة إلى JPG أو PNG قبل الفحص.",
  unsupportedImageFormat: "تنسيق الصورة غير مدعوم. استخدم JPG أو PNG أو WEBP أو GIF.",
  shareLinkReady: "رابط الصورة جاهز",
  copyAgain: "نسخ مرة أخرى",
  manualCopyHint: "الرابط جاهز. انسخه من الحقل أدناه.",
  signInToCopyLink: "سجّل الدخول كعضو لنسخ روابط الصور.",
  sharePermissionDenied: "تم رفض إذن Firestore. اسمح للأعضاء المسجلين بإنشاء روابط صور مشتركة.",
  shareImageTooLarge: "الصورة ذات العلامة كبيرة جداً لإنشاء رابط مشاركة.",
  shareFirebaseUnavailable: "Firebase غير جاهز بعد.",
  noteBody: "تقدر هذه الأداة مخاطر إنشاء الصورة بالذكاء الاصطناعي من الإشارات البصرية وإشارات المزود. النتائج احتمالية وقد تكون خاطئة ولا يجب استخدامها كأساس وحيد لقرارات قانونية أو مالية أو توظيفية أو أكاديمية أو عالية التأثير.",
  supportTitle: "هل تحتاج مساعدة؟",
  supportBadge: "دعم بشري",
  supportBody: "تواصل مع دعم PIC Check إذا احتجت مساعدة في نتائج الفحص أو الوصول للحساب أو تحذيرات الحصة.",
  supportEmail: "الدعم عبر البريد",
  supportTelegram: "الدردشة على Telegram",
  supportBotTitle: "دعم PIC Check",
  supportBotStatus: "عادة يرد بسرعة",
  supportBotBody: "هل تحتاج مساعدة في نتيجة فحص أو تحذير حصة API؟ تواصل معنا مباشرة.",
  supportBotOpen: "فتح الدعم",
  supportBotHide: "إخفاء الدعم",
  firebaseMissing: "لم يتم إعداد Firebase بعد. أضف إعداد Firebase لتفعيل تسجيل الدخول.",
  firebaseReady: "Firebase جاهز. تابع عبر Google لاستخدام مزايا العضو.",
  authFailed: "فشل تسجيل الدخول. تحقق من إعداد المزود وبيانات الاعتماد.",
  authUnauthorizedDomain: "تسجيل الدخول عبر Google محظور لهذا النطاق. افتح التطبيق عبر http://localhost:3000 أو أضف النطاق في Firebase Authentication > Settings > Authorized domains.",
  authPopupBlocked: "تم حظر نافذة تسجيل الدخول من Google. اسمح بالنوافذ المنبثقة وحاول مرة أخرى.",
  authOperationNotAllowed: "مزود Google غير مفعل في مشروع Firebase هذا.",
  authRedirecting: "جار فتح تسجيل الدخول عبر Google...",
  memberLimit: "مزايا العضو: فحص 3 صور مرة واحدة، المتابعة بعد حد 5 صور للضيف، ومشاركة روابط الأدلة.",
  localFallback: "API غير متاح. تم استخدام fallback heuristic محلي.",
  providerLimitFallback: "مزودو كشف الذكاء الاصطناعي الموثوقون مقيدون حالياً أو نفدت حصتهم. النتيجة المحلية أقل دقة. تواصل عبر johnlahboo@gmail.com أو Telegram @movewannamove للإبلاغ والحصول على المساعدة.",
  provider: "المزود",
  providerScore: "أعاد {provider} نتيجة AI قدرها {score}%.",
  cacheSource: "تم تحميل النتيجة من cache {layer}.",
  fallbackChain: "سلسلة مزودي fallback: {chain}.",
  screenshotNote: "تبدو الصورة كلقطة شاشة/واجهة، لذلك يجب تفسير الثقة بحذر.",
  aiMarker: "AI Generated {score}%",
  aiEditedMarker: "تحذير تعديل AI {score}%",
  viewingResult: "عرض النتيجة",
  selectedForScan: "محدد للفحص",
  authNeeded: "سجّل الدخول لفحص 3 صور مرة واحدة أو المتابعة بعد 5 فحوصات كضيف.",
  firebaseNotReady: "Firebase غير مهيأ بعد.",
  fileModeWarning: "API غير متاح لأن التطبيق مفتوح كملف محلي. شغّل npm run dev وافتح http://127.0.0.1:3000.",
  unableAnalyze: "تعذر تحليل هذه الصورة.",
  browserReadError: "لم يستطع المتصفح قراءة هذه الصورة.",
  smoothSynthetic: "انتقالات اللون الناعمة قد تشبه النسيج الاصطناعي.",
  naturalVariation: "التنوع الطبيعي يخفض درجة مخاطر AI.",
  lowEdges: "انخفاض كثافة الحواف الحادة يشير إلى صورة ناعمة أو ملسّنة.",
  clearEdges: "تفاصيل الحواف الواضحة تخفض درجة مخاطر AI.",
  limitedBrightness: "تنوع السطوع المحدود قد يشير إلى render أو معالجة قوية.",
  diverseBrightness: "توزيع السطوع المتنوع يخفض درجة المخاطر.",
  highSaturation: "تشبع اللون العالي قد يظهر في الصور المولدة.",
  squareFormat: "التنسيق المربع عالي الدقة شائع في أدوات توليد الصور.",
  pngWebp: "PNG/WEBP غالباً يحتوي على آثار كاميرا أقل من صور JPEG.",
  scoreRule: "قاعدة القرار: أعلى من {threshold}% يصنف كمولد AI، من {realThreshold}% إلى {threshold}% كتعديل محتمل بمساعدة AI، وأقل من {realThreshold}% كصورة حقيقية؛ حصلت هذه الصورة على {score}%.",
  smoothnessMetric: "النعومة: {value}% من الانتقالات المأخوذة كانت ناعمة جداً. القيم العالية قد تشير إلى نسيج مولد أو معالجة قوية.",
  edgeMetric: "كثافة الحواف: {value}% من المناطق المأخوذة بها تباين حاد. الصور الحقيقية غالباً تحتفظ بحواف غير منتظمة وتفاصيل دقيقة.",
  entropyMetric: "تنوع السطوع: {value}%. الانخفاض قد يأتي من لقطات UI أو رسوم أو render أو صور مضغوطة/مولدة.",
  saturationMetric: "متوسط التشبع: {value}%. اللون المتساوي أو المحسن جداً قد يزيد الشك، لكنه إشارة ضعيفة فقط.",
  dimensionMetric: "حجم الصورة: {width} × {height}. الملفات المربعة عالية الدقة شائعة في أدوات التوليد؛ لقطات الشاشة تحتاج تفسير ثقة أقل.",
  screenshotMetric: "فحص لقطة الشاشة: {result}. الصور المشابهة للقطات قد تبدو ناعمة اصطناعياً، لذلك تقلل هذه الإشارة الادعاءات المفرطة.",
  screenshotYes: "تشبه لقطة شاشة",
  screenshotNo: "لا تشبه لقطة شاشة بوضوح",
  formatMetric: "فحص التنسيق: {format}. PNG/WEBP غالباً يفتقر إلى metadata الكاميرا، لكن التنسيق وحده ليس دليلاً."
});
